     ...
     #+begin_src emacs-lisp
       (use-package org-agenda
         ...
         (defun org-clock-clear-file-after-clock-out ()
           (with-temp-file org-clock-current-task-file
             (insert "")))
         :hook ((org-clock-in-hook . org-clock-current-task-to-file)
                (org-clock-out-hook . org-clock-clear-file-after-clock-out))
         :init
...
**** ox-hugo
     #+begin_src emacs-lisp
       (use-package ox-hugo
         ...
         :config
         (defun org-hugo-set-bundle-and-export-file-name (draft-position)
               ...
               (with-current-buffer (find-file-noselect org-file nil nil nil)
                 (save-excursion
                   ...
                   (let ((draft-position (re-search-forward "^#\\+hugo_draft: false$" nil t))
                     ...
                     (when draft-position
                       (org-hugo-set-bundle-and-export-file-name draft-position)
