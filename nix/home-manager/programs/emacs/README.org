...
**** org-mode
     #+begin_src emacs-lisp
       (use-package org
         ...
         (org-capture-templates `(("i" " Inbox" entry (file+headline org-gtd-file "Inbox")
...
**** org gtd
     #+begin_src emacs-lisp
       (use-package org-agenda
         ...
         :hook ((before-save-hook . my:org-roam-update-task-tag)
                (org-clock-in-hook . org-clock-current-task-to-file)
