       ...
       (use-package org-roam
         ...
         (defun my:org-agenda-update-files (&rest _)
           ...
           (let ((task-files (my:org-roam-get-task-files))
                 (paper-files (when (file-directory-p my:d:paper-notes-papers)
                                (directory-files-recursively my:d:paper-notes-papers "\\.org\\'"))))
             (setq org-agenda-files (append (list my:d:org-gtd) task-files paper-files))
