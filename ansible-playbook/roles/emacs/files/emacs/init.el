...
;; <leaf-install-code>
(eval-and-compile (customize-set-variable 'package-archives '(("org" . "https://orgmode.org/elpa/")
                                                              ("melpa" .
...
(leaf *initialize-emacs
  :config (leaf exec-path-from-shell
            :ensure t
...
(leaf *minor-mode
  ...
  (leaf nyan-mode
    ...
    :hook ((doom-modeline-mode-hook . nyan-mode)))
  (leaf projectile
    :ensure t
    :init
