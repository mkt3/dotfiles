...
**** org-mode
     #+begin_src emacs-lisp
       (use-package org
         ...
         (org-gtd-engage-prefix-width 32)
         :config
...
**** org-gtd
     #+begin_src emacs-lisp
       (use-package org-gtd
         ...
         :custom
         (org-gtd-directory my:d:org-gtd)
         (org-edna-use-inheritance t)
         (org-gtd-organize-hooks '(org-gtd-set-area-of-focus))
         (org-gtd-areas-of-focus '("Personal" "Home" "Research" "Work"))
         :config
         (org-edna-mode 1)
         :bind
...
* Rss
  #+begin_src emacs-lisp
    ...
    (use-package elfeed-protocol
      ...
      :config
      ;; (load (expand-file-name "personal_config/emacs_mail/config.el" my:d:nextcloud))
                                            ; mail server config
      (setq elfeed-feeds
...
** mu4e
   #+begin_src emacs-lisp
     (use-package mu4e
       ...
       (load (expand-file-name "personal_config/emacs_mail/config.el.gpg" my:d:nextcloud)) ; mail server config
       )
   #+end_src
