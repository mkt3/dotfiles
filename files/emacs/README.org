...
** mu4e
   #+begin_src emacs-lisp
     (use-package mu4e
       ...
       :load-path (lambda () (if (eq system-type 'darwin) (expand-file-name ".local/state/nix/profile/share/emacs/site-lisp/mu4e" (getenv "HOME")) "/usr/share/emacs/site-lisp/mu4e/"))
       :demand t
       :bind (("C-c m" . mu4e)
