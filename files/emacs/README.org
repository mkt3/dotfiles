...
** mu4e
   #+begin_src emacs-lisp
     (use-package mu4e
       ...
       (load (expand-file-name "personal_config/emacs_mail/mu4e_config.el" my:d:nextcloud)) ; mail server config
       )
   #+end_src
...
** prodigy
   #+begin_src emacs-lisp
     (use-package prodigy
       :ensure t
       :if (and (executable-find "goimapnotify") (file-directory-p my:d:nextcloud))
       :commands (prodigy
