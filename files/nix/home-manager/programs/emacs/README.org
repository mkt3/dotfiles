...
** skk
   #+begin_src emacs-lisp
     (use-package ddskk
       ...
       (setq viper-mode nil)
       :config
       (defun my:open-skk-input-buffer ()
         (interactive)
         (let* ((tab-name "SKK Input")
                (tabs (tab-bar-tabs))
                (target-tab (seq-find (lambda (tab)
           ...
           (if target-tab
             ...
             (let ((buf (get-buffer-create "*SKK Input*")))
...
**** org-roam
     #+begin_src emacs-lisp
       ...
       (use-package citar-org-roam
         ...
         :if (file-exists-p my:f:bib)
         :hook (citar-mode . citar-org-roam-mode)
         :config
