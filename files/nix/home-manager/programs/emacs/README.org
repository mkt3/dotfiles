...
** Auto package update
   #+begin_src emacs-lisp
     (use-package auto-package-update
       ...
       (setq auto-package-update-excluded-packages '(pdf-tools jinx mu4e ox-hugo))
...
** Load Path
   #+begin_src emacs-lisp
     (use-package exec-path-from-shell
       ...
       :config
       (setq exec-path-from-shell-arguments nil) ;; Since the UI is set to interactive in .zshrc.
       (setq exec-path-from-shell-variables  '("PATH" "NAME" "ORG_HUGO" "SSH_AUTH_SOCK" "SSH_AGENT_PID" "GNUPGHOME" "PASSWORD_STORE_DIR" "GPG_KEY_ID" "RECOLL_CONFDIR" "CMIGEMO_DICT"))
...
*** orderless & migemo
    #+begin_src emacs-lisp
      ...
      (use-package migemo
        ...
        (setq migemo-dictionary (getenv "CMIGEMO_DICT"))
