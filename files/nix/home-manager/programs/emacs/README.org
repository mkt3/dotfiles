   ...
   #+begin_src emacs-lisp
     (when (display-graphic-p)
       (if (eq system-type 'darwin)
           (set-frame-font "PlemolJP Console NF-18" nil t)
         (set-frame-font "PlemolJP Console NF-16" nil t))
       (set-fontset-font t 'symbol "Hack Nerd Font" nil 'append)
       (set-fontset-font t 'unicode "Hack Nerd Font" nil 'append))
...
*** git
    #+begin_src emacs-lisp
      ...
      (use-package magit
        ...
        :config
        ;; (magit-wip-mode 1) is commented out because it slows down staging operations on macOS by triggering multiple autosave Git commands.
