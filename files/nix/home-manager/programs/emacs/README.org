...
**** jsx-mode
     #+begin_src emacs-lisp
       (use-package jtsx
         ...
         :hook ((jtsx-jsx-mode-hook . hs-minor-mode)
                (jtsx-tsx-mode-hook . hs-minor-mode)
                (jtsx-typescript-mode-hook . hs-minor-mode))
         :custom
         (js-indent-level 2)
    ...
    #+begin_src emacs-lisp
      (use-package markdown-mode
        ...
        :hook (markdown-mode-hook . (lambda ()
                                      (setq tab-width 2)
                                      (turn-on-orgtbl)
                                      (setf (alist-get 'markdown-mode eglot-server-programs) '("marksman"))
                                      (eglot-ensure))))
    #+end_src
*** YAML
    #+begin_src emacs-lisp
